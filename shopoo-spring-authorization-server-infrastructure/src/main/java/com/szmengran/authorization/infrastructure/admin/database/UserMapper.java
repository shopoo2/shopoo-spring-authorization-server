...
public interface UserMapper extends BaseMapper<Oauth2User> {
	...
	String querySql1 = "select a.*, c.name roleName from oauth2.oauth2_user a, oauth2.oauth2_user_role_r b, oauth2.oauth2_role c where b.role_id = c.role_id and a.user_id = b.user_id";
