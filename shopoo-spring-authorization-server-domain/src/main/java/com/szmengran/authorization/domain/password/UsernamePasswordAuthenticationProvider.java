...
//    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
//        CustomerUsernamePasswordAuthenticationToken customerUsernamePasswordAuthenticationToken = (CustomerUsernamePasswordAuthenticationToken)authentication;
//        Map<String, Object> map = customerUsernamePasswordAuthenticationToken.getAdditionalParameters();
//        String username = (String)map.get("username");
//        String password = (String)map.get("password");
//        UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = UsernamePasswordAuthenticationToken.authenticated(username, password, Collections.emptyList());
//
//        OAuth2ClientAuthenticationToken clientPrincipal = OAuth2AuthenticationProviderUtils.getAuthenticatedClientElseThrowInvalidClient(customerUsernamePasswordAuthenticationToken);
//        RegisteredClient registeredClient = clientPrincipal.getRegisteredClient();
...
//        }
//        OAuth2Authorization.Builder authorizationBuilder = OAuth2Authorization.withRegisteredClient(registeredClient).principalName(username).authorizationGrantType(AuthorizationGrantType.PASSWORD);
...
//            }
//
//            DefaultOAuth2TokenContext.Builder tokenContextBuilder = DefaultOAuth2TokenContext.builder().registeredClient(registeredClient).principal(customerUsernamePasswordAuthenticationToken).authorizationServerContext(AuthorizationServerContextHolder.getContext()).authorization(authorization).authorizedScopes(authorization.getAuthorizedScopes()).authorizationGrantType(AuthorizationGrantType.PASSWORD);
//            OAuth2TokenContext tokenContext = tokenContextBuilder.tokenType(OAuth2TokenType.ACCESS_TOKEN).build();
//            OAuth2Token generatedAccessToken = this.tokenGenerator.generate(tokenContext);
...
//
//                OidcIdToken idToken;
//                if (customerUsernamePasswordAuthenticationToken.getScopes().contains("openid")) {
